...
public class PostsActivity extends Activity implements PostsView {

    private ArrayList cardWalls = new ArrayList<>();
    ...
    @Override
    public void setData(ArrayList<CardWall> cardWalls) {
        LinearLayoutManager layoutManagerForCards = new LinearLayoutManager(getApplicationContext());
